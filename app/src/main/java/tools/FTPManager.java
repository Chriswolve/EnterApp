...
import com.example.cristhian.enterapp.R;
...
public class FTPManager {
    ...
    public void connect_to_server(){
        try{
            ...
            Log.i("Connect to server",e.toString());
        }
    }
    public void change_directory(String folder_id){
        try{
            ...
            Log.i(" Change_directory :",e.toString());
        }
    ...
    public void Close_connection(){
        try {
            ...
            Log.i("Close_connection:",e.toString());
        }
